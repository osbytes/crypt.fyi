...
export const es: TranslationKeys = {
  ...
  landing: {
    ...
    subtitle: 'Envía contraseñas e información sensible con cifrado de extremo a extremo de conocimiento cero y eliminación automática',
    steps: {
      encrypt: {
        title: '1. Cifrar',
    ...
    form: {
      ...
      advanced: {
        ...
        ip: {
          ...
          description: 'Restringir el acceso a direcciones IP específicas o bloques CIDR (separados por comas)',
        },
        readCount: {
  ...
  view: {
    ...
    content: {
      ...
      passwordProtected: 'Este secreto está protegido con contraseña. Haz clic para ingresar la contraseña.',
      clickToEnterPassword: 'Haz clic para ingresar la contraseña',
    },
    info: {
      burnedAfterReading: 'Este secreto fue eliminado después de tu visualización y ya no estará disponible al salir de la página.',
  ...
  about: {
    ...
    whyCryptFyi: {
      ...
      existingSolutions: {
        ...
        limitations: {
          ...
          otherTools: 'PrivateBin/PwPush/OneTimeSecret - funcionalidad básica similar, pero interfaces de usuario desactualizadas y pilas tecnológicas antiguas, además de algunas',
      ...
      approach: {
        ...
        description: 'crypt.fyi fue construido para abordar estos desafíos mientras adopta tecnologías web modernas. Combina los principios de seguridad de las soluciones existentes con una interfaz limpia e intuitiva y una pila tecnológica moderna. El resultado es una herramienta que es tanto altamente segura como agradable de usar.',
      },
    },
    howItWorks: {
      title: 'Cómo Funciona',
      steps: {
        encrypt: {
          title: '1. Cifrar',
          description: 'Tu secreto se cifra directamente en tu navegador antes de salir de tu dispositivo. Solo las personas con el enlace especial, que has compartido explícitamente, pueden descifrarlo.',
        },
        share: {
          title: '2. Compartir',
          description: 'Comparte el enlace seguro con tu destinatario. El enlace contiene todo lo necesario para descifrar el mensaje, a menos que se especifique una contraseña.',
        },
        burn: {
          title: '3. Destruir después de leer',
          description: 'Una vez accedido, si "destruir después de leer" está marcado, el secreto se elimina permanentemente de nuestros servidores. Sin dejar rastros.',
        },
      },
    },
    security: {
      ...
      encryption: {
        ...
        description: 'Todos los secretos se cifran usando cifrado AES-256-GCM en tu navegador antes de la transmisión. La clave de cifrado nunca sale de tu dispositivo, asegurando un verdadero cifrado de extremo a extremo.',
        features: {
      ...
      zeroKnowledge: {
        ...
        description: 'Nuestros servidores nunca ven tus datos sin cifrar. Empleamos una arquitectura de conocimiento cero donde:',
        features: {
    ...
    openSource: {
      ...
      description: 'crypt.fyi es de código abierto y auditable. Puedes revisar nuestro código, enviar problemas y contribuir en',
